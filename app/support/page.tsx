  ...
  const faqs = [
    {
      ...
      items: [
        {
          q: "プレミアムプランの料金は？",
          a: "月額500円（税込）です。初回7日間は無料でお試しいただけます。",
        },
        {
          q: "無料版との違いは何ですか？",
          a: "プレミアムプランでは、AI機能が無制限、広告非表示、全年度の過去問アクセス、AI問題生成、詳細な学習分析などがご利用いただけます。無料版ではAI機能は月3回まで、過去問は直近3年分のみとなります。",
        },
        {
          q: "解約方法を教えてください",
          a: "iPhoneの設定 → [あなたの名前] → サブスクリプション から「宅建合格ロード」を選択し、「サブスクリプションをキャンセルする」をタップしてください。",
        },
        {
          q: "解約後はどうなりますか？",
          a: "現在の契約期間が終了するまでプレミアム機能をご利用いただけます。契約期間終了後は自動的に無料版に切り替わります。",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: "過去7年分（令和3年〜令和8年度）の本試験問題を収録しています。無料版では直近3年分のみご利用いただけます。",
        },
        {
          q: "オフラインでも使えますか？",
        ...
        {
          q: "AI先生に質問できる回数は？",
          a: "無料版は月3回まで、プレミアムプランでは無制限です。質問回数は毎月1日にリセットされます。",
        },
        {
          q: "学習データは引き継げますか？",
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "購入が反映されません",
          a: "設定画面の「購入の復元」ボタンをタップしてください。それでも解決しない場合は、レシートを添えてお問い合わせください。",
        },
        {
          q: "アカウントを削除したい",
