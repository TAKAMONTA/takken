        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="space-y-6 text-sm text-gray-700">
            <section>
              ...
              <p>
                本利用規約（以下「本規約」）は、宅建合格ロード（以下「本アプリ」）の利用条件を定めるものです。ユーザーは本規約に同意の上、本アプリをご利用ください。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                本アプリの利用を希望する方は、本規約に同意の上、利用登録を申請してください。当方は、利用登録の申請者に以下の事由があると判断した場合、利用登録の申請を承認しないことがあります：
              </p>
            ...
            <section>
              ...
              <p>
                当方は、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、ユーザーに対して、本アプリの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします：
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>本アプリについて、最終の利用から一定期間利用がない場合</li>
                <li>その他、当方が本アプリの利用を適当でないと判断した場合</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                本規約の解釈にあたっては、日本法を準拠法とします。本アプリに関して紛争が生じた場合には、沖縄県那覇市を管轄する裁判所を専属的合意管轄とします。
              </p>
            </section>
