...
const weaknessQuestions = {
  'juuyou-jikoku': [
    {
      id: 1,
      question: "宅地建物取引業者が行う重要事項の説明に関する次の記述のうち、宅地建物取引業法の規定によれば、正しいものはどれか。",
      options: [
      ...
      correctAnswer: 2,
      explanation: "宅建業法第35条により、重要事項の説明は宅地建物取引士が取引士証を提示して行わなければなりません。説明と書面の交付は契約締結前に行い、相手方に交付する必要があります。",
      category: "宅建業法",
      weakness: "説明義務者の要件が曖昧",
      studyTip: "35条書面は「説明+交付」がセット、37条書面は「交付のみ」と覚えましょう"
    },
    {
      id: 2,
      question: "35条書面（重要事項説明書）の記載事項に関する次の記述のうち、宅地建物取引業法の規定によれば、誤っているものはどれか。",
      options: [
      ...
      correctAnswer: 3,
      explanation: "35条書面には損害賠償額の予定又は違約金に関する事項も記載しなければなりません。これは契約締結前に買主等が知っておくべき重要な事項だからです。",
      category: "宅建業法",
      weakness: "35条書面の記載事項の理解不足",
      studyTip: "35条書面は「契約前に知るべき事項」、37条書面は「契約内容の確認事項」と区別して覚えましょう"
    }
  ],
  'teitouken': [
    {
      id: 3,
      question: "Aが所有する甲土地にBが1番抵当権、Cが2番抵当権を設定している場合に関する次の記述のうち、民法の規定によれば、正しいものはどれか。",
      options: [
      ...
      correctAnswer: 0,
      explanation: "抵当権の効力は原則として抵当権設定時に存在していた物に限られます。抵当権設定後に新築された建物は、別個の不動産として扱われ、抵当権の効力は及びません。",
      category: "民法等",
      weakness: "抵当権の効力の及ぶ範囲",
      studyTip: "抵当権は「設定時に存在していた物」が原則。後から追加された物には及ばないと覚えましょう"
    }
  ],
  'toshikeikaku': [
    {
      id: 4,
      question: "都市計画法に関する開発許可に関する次の記述のうち、正しいものはどれか。",
      options: [
      ...
      correctAnswer: 0,
      explanation: "市街化区域内では1,000㎡以上の開発行為に開発許可が必要です。1,500㎡は1,000㎡以上なので許可が必要です。市街化調整区域では原則すべて、非線引き区域等では3,000㎡以上が対象です。",
      category: "法令上の制限",
      weakness: "開発許可の対象・規模",
      studyTip: "市街化区域1,000㎡、非線引き等3,000㎡、市街化調整区域は原則全て許可必要と覚えましょう"
    }
  ],
  'fudousan-shutokuzei': [
    {
      ...
      correctAnswer: 2,
      explanation: "新築住宅については、床面積等の要件を満たせば課税標準から1,200万円（長期優良住宅等は1,300万円）が控除されます。不動産取得税は地方税で、相続による取得は非課税、住宅・住宅用土地は軽減税率3%です。",
      category: "税・その他",
      weakness: "課税標準の特例適用要件",
      studyTip: "新築住宅は1,200万円控除、住宅用土地は軽減税率3%、相続は非課税と覚えましょう"
    }
  ]
};
...
function WeakPointsQuizContent() {
  ...
  useEffect(() => {
    ...
    if (topic && weaknessQuestions[topic as keyof typeof weaknessQuestions]) {
      const topicQuestions = weaknessQuestions[topic as keyof typeof weaknessQuestions];
      ...
      switch (method) {
        ...
        case 'mixed':
          ...
          selectedQuestions = allWeakQuestions.sort(() => Math.random() - 0.5).slice(0, 8);
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
        <div className="bg-white shadow-sm border-b">
          <div className="max-w-md mx-auto px-4 py-4">
            <h1 className="text-xl font-bold text-gray-800 text-center">弱点克服結果</h1>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto px-4 py-8 space-y-6">
          <div className="bg-gradient-to-r from-red-500 to-pink-500 rounded-xl p-6 shadow-sm text-center text-white">
            ...
            <p className="text-white/90 mb-4">
              {score >= 80 ? '素晴らしい改善です！' : 
               score >= 60 ? '着実に克服できています！' : 'もう少し練習が必要です'}
            </p>
                ...
                <div key={index} className="border rounded-lg p-3">
                  ...
                  {!answers[index] && question.weakness && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded p-2 mt-2">
                      <div className="text-xs font-bold text-yellow-800 mb-1">弱点ポイント</div>
                      <div className="text-xs text-yellow-700">{question.weakness}</div>
                      {question.studyTip && (
                        <>
                          <div className="text-xs font-bold text-yellow-800 mt-2 mb-1">学習のコツ</div>
                          <div className="text-xs text-yellow-700">{question.studyTip}</div>
                        </>
                      )}
                    </div>
                  )}
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h3 className="font-bold text-lg mb-4 text-gray-800">🎯 次のステップ</h3>
            <div className="space-y-3">
              {score < 80 && (
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                  <div className="font-bold text-orange-800 mb-1">📚 復習推奨</div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="font-bold text-blue-800 mb-1">💡 学習アドバイス</div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          {currentQuestion.weakness && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
              <div className="text-xs font-bold text-yellow-800 mb-1">🎯 この問題の弱点ポイント</div>
              <div className="text-xs text-yellow-700">{currentQuestion.weakness}</div>
            </div>
          )}
          ...
          {showExplanation && (
            <div className="space-y-4 mb-6">
              ...
              {currentQuestion.studyTip && showDetailedExplanation && (
                <div className="bg-blue-50 rounded-lg p-4">
                  <h3 className="font-bold text-sm text-blue-800 mb-2">💡 学習のコツ</h3>
